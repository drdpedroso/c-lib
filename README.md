...
```
  > git clone git@github.com:drdpedroso/c-lib.git
  > cd react-rollup-boilerplate
  > yarn install
```

#### Not Familiar with Git?
Click [here](https://github.com/drdpedroso/c-lib/archive/master.zip) to download the .zip file.  Extract the contents of the zip file, then open your terminal, change to the project directory, and:
